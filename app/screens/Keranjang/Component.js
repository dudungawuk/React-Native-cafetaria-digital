      ...
      <View style={{ backgroundColor: '#c4c4c4', justifyContent: 'center', alignItems: 'center' }}>
        ...
        >
          ...
          <View style={{ flexDirection: 'row', marginLeft: 26, marginTop: 29 }}>
            ...
            <View style={{ flexDirection: 'column' }}>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <Text style={{ marginLeft: 5, fontSize: 15, color: '#c4c4c4' }}>x</Text>
                <Text style={{ marginLeft: 5, fontSize: 15, color: '#c4c4c4' }}>2</Text>
              </View>
            </View>
            <View style={{ justifyContent: 'center', alignItems: 'flex-end', marginLeft: 170 }}>
              <Image source={IMAGES.edit} style={{ width: 20, height: 20, borderRadius: 3 }} />
            </View>
          </View>
          <View style={{ flexDirection: 'row', marginLeft: 26, marginTop: 29 }}>
            <Image source={IMAGES.thumbnail2} style={{ width: 50, height: 50, borderRadius: 3 }} />
          ...
          <View style={{ marginTop: 20, justifyContent: 'center', alignItems: 'center' }}>
            <View style={{ backgroundColor: '#c4c4c4', width: 330, height: 1 }} />
          </View>
          <View style={{ flexDirection: 'row', marginTop: 10, marginLeft: 26 }}>
            <Text style={{ color: '#c4c4c4' }}>Subtotal</Text>
            <Text style={{ color: '#c4c4c4', marginLeft: 195 }}>Rp. 60.000</Text>
          </View>
